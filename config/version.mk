...
BANANA_VERSION := BananaDroid-$(BANANA_MOD_VERSION)-$(BANANA_BUILD)-$(BANANA_BUILD_TYPE)-$(BANANA_BUILD_DATE)-$(BANANA_EDITION)
BANANA_FINGERPRINT := BananaDroid/$(BANANA_MOD_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(BANANA_BUILD_DATE)/$(BANANA_EDITION)
BANANA_DISPLAY_VERSION := BananaDroid-$(BANANA_MOD_VERSION)-$(BANANA_BUILD_TYPE)-$(BANANA_BUILD_DATE)-$(BANANA_EDITION)
