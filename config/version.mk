...
BANANA_VERSION := BananaDroid-$(BANANA_CODENAME)-$(BANANA_MOD_VERSION)-$(BANANA_BUILD)-$(BANANA_BUILD_TYPE)-$(BANANA_BUILD_DATE)-$(BANANA_EDITION)
BANANA_FINGERPRINT := BananaDroid/$(BANANA_CODENAME)/$(BANANA_MOD_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(BANANA_BUILD_DATE)/$(BANANA_EDITION)
BANANA_DISPLAY_VERSION := BananaDroid-$(BANANA_CODENAME)-$(BANANA_MOD_VERSION)-$(BANANA_BUILD_TYPE)-$(BANANA_BUILD_DATE)-$(BANANA_EDITION)

PRODUCT_GENERIC_PROPERTIES += \
  ro.banana.version=$(BANANA_VERSION) \
  ro.banana.releasetype=$(BANANA_BUILD_TYPE) \
  ro.modversion=$(BANANA_CODENAME)-$(BANANA_MOD_VERSION) \
