...
removal_manifest = ".repo/local_manifests/00_banana_removals.xml"
tmp_removal_manifest = ".repo/local_manifests/tmp_banana_removals.xml"
...
def fetch_dependencies(repo_path):
    ...
    dependencies_path = repo_path + '/banana.removal.dependencies'
    syncable_repos = []
...
def remove_removals(removal_manifest):
    tmp_manifest_disable = ".repo/local_manifests/local_banana.xml"
